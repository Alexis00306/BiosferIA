...
<body class="min-vh-100 d-flex flex-column">
  ...
  <!-- Contenedor centrado -->
  <div class="container-fluid flex-grow-1 d-flex justify-content-center align-items-center bg-light">
    <div class="w-100 p-4" style="max-width: 400px;">
      ...
      <form>
        ...
        <div class="d-grid mb-3">
          <a type="submit" class="btn btn-primary" href="../paginas/inicio.php">Iniciar sesión</a>
        </div>
      </form>
